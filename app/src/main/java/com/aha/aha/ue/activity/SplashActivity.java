...
import com.aha.aha.ue.frag.Frag_guide1;
import com.aha.aha.ue.frag.Frag_guide2;
import com.aha.aha.ue.frag.Frag_guide3;
import com.aha.aha.ue.frag.Frag_splash;
...
public class SplashActivity extends RootMAActivity {
    ...
    private Class[] frags = {//
            ...
            Frag_test.class,// 测试页
            Frag_guide1.class,// 引导1
            Frag_guide2.class,// 引导2
            Frag_guide3.class,// 引导3
    ...
    public RootProperty initProperty() {
        ...
        // 指定状态栏颜色
        rootProperty.setColorStatusBar(R.color.colorTheme);
        rootProperty.setStatusbarAlpha(0.0f);
